...
#index is built in rubyonrails. Here we are overriding the default index with our custom index
index do
  column :id
...
#form is built in rubyonrails. This will override the default form to create a page with custom form
form do |f|
  f.inputs "Details" do
